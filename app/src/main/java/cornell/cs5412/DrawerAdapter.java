...
public class DrawerAdapter extends RecyclerView.Adapter<DrawerAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView,int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                Name = (TextView) itemView.findViewById(R.id.drawer_user_name);         // Creating Text View object from header.xml for name
    ...
    DrawerAdapter(String Titles[],int Icons[],String Name, Bitmap Profile){ // DrawerAdapter Constructor with titles and icons parameter
        // titles, icons, name, profile pic are passed from the main activity as we
